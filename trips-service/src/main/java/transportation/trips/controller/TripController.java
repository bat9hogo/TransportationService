...
public class TripController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TripResponseDto> getTripById(@PathVariable("id") String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TripResponseDto> updateTrip(@PathVariable("id") String id,
    ...
    public ResponseEntity<TripResponseDto> updateTripStatus(@PathVariable("id") String id,
